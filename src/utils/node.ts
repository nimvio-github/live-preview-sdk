 ...
 * the app-container. This element should either be positioned (position is anything except static) or should
 ...
 * @param {HTMLElement} element
 */
export function getElementAncestors (element: HTMLElement): readonly HTMLElement[] {
  const ancestors = []
