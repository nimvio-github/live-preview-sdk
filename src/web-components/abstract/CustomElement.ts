...
export abstract class CustomElement extends HTMLElement {
  ...
  public static get is (): string {
    throw new Error('"is" getter is not implemented for this custom element')
  }
  ...
  public static async define (): Promise<void> {
   ...
   * Each custom element class should implement this static method.
   *
   * @returns {HTMLTemplateElement}
   */
  protected static initializeTemplate (): HTMLTemplateElement {
    throw new Error('"initializeTemplate" method should be implemented for every component.')
  }
